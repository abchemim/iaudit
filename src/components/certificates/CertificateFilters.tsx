...
import { CertificateType, CertificateStatus, CERTIFICATE_TYPE_LABELS } from "@/hooks/useCertificates";

interface CertificateFiltersProps {
  search: string;
  onSearchChange: (value: string) => void;
  selectedType: CertificateType | undefined;
  onTypeChange: (value: CertificateType | undefined) => void;
  selectedStatus: CertificateStatus | undefined;
  onStatusChange: (value: CertificateStatus | undefined) => void;
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4">
      ...
      <Select
        ...
        onValueChange={(value) => onTypeChange(value === "all" ? undefined : (value as CertificateType))}
      >
      ...
      <Select
        ...
        onValueChange={(value) => onStatusChange(value === "all" ? undefined : (value as CertificateStatus))}
      >
