import { FileCheck, Building2, Wallet, Calculator, Mail, Users, Send, FolderOpen, CheckSquare } from "lucide-react";
    ...
    <section id="features" className="py-24 relative">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-sm font-medium text-primary mb-4 block">Funcionalidades</span>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Tudo que você precisa para <span className="text-gradient">automatizar seu escritório</span>
          </h2>
