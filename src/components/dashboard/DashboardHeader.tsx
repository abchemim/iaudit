      ...
      <header className="h-16 border-b border-border bg-card/50 backdrop-blur-xl flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4 mx-0 px-0 pl-[240px] ml-0">
          ...
          <div className="relative hidden md:block" ref={searchRef}>
            ...
            setShowResults(true);
          }} onFocus={() => setShowResults(true)} className="w-72 pl-10 pr-8 py-2 bg-secondary border border-border rounded-lg text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
